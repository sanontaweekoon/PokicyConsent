    ...
    <form class="container mx-auto">
      ...
      <div class="space-y-2">
        ...
        <div class="grid grid-rows-1">
          <div class="flex my-5">
            <label class="mr-3 font-medium text-nowrap">เวลาประกาศ: </label>
...
async function loadPolicy(id) {
  ...
  form.value.publish_date = payload.publish_date
    ? normalizeDate(payload.publish_date)
    : fromPublishAtDate || "";
  form.value.publish_time = payload.publish_time
    ? normalizeTime(payload.publish_time)
    : fromPublishAtTime || "";
