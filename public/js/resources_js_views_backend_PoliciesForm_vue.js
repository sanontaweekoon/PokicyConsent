...
/* harmony import */ var _services_BackendService_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/BackendService.js */ "./resources/js/services/BackendService.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    __expose();
    var editorContainer = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)(null);
    var quInstance = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)(null);
    var content = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)(''); // เก็บ text จาก Quill editor
    var appFont = typeof window !== 'undefined' ? getComputedStyle(document.body).fontFamily || 'Kanit, sans-serif' : 'Kanit, sans-serif';
    var _editable = null;
    var _quillKeydownHandler2 = null;
    var _quillChangeHandler = null;
    var _quillEditorChangeHandler = null;
    var _quillMutObserver = null;

    // หา Quill instance และ root element
    function resolveQuill() {
      var root = document.querySelector('.ql-editor');
      return {
        qu: quInstance.value,
        root: root
      };
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.onBeforeUnmount)(function () {
      try {
        if (_editable && _quillKeydownHandler2) {
          _editable.removeEventListener('keydown', _quillKeydownHandler2, true);
        }
        try {
          var _resolveQuill = resolveQuill(),
            qu = _resolveQuill.qu;
          if (qu) {
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.onMounted)(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var instance, root, updateContentFromInstance, inner;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          ...
          case 2:
            ...
            return _context.a(2);
          case 3:
            quInstance.value = new quill__WEBPACK_IMPORTED_MODULE_0__["default"](editorContainer.value, quillOptions);
            instance = quInstance.value;
            root = (instance === null || instance === void 0 ? void 0 : instance.root) || editorContainer.value.querySelector('.ql-editor');
            if (content.value && content.value.trim() !== '') {
              try {
                instance.clipboard.dangerouslyPasteHTML(content.value);
              } catch (e) {}
            }
            updateContentFromInstance = function updateContentFromInstance() {
              try {
                var html = instance && instance.root ? instance.root.innerHTML : root ? root.innerHTML : '';
            ...
            if (instance && typeof instance.on === 'function') {
              _quillChangeHandler = function _quillChangeHandler() {
                return updateContentFromInstance();
              };
              instance.on('text-change', _quillChangeHandler);
              _quillEditorChangeHandler = function _quillEditorChangeHandler() {
                return updateContentFromInstance();
              };
            ...
            if (root) {
              try {
                ...
                _quillMutObserver = new MutationObserver(function () {
                  try {
                    var _inner = root.innerHTML || '';
                    content.value = _inner && _inner.trim() === '<p><br></p>' ? '' : _inner;
                  } catch (e) {
                    /* ignore */
                  }
                });
            ...
            if (root) {
              _editable = root;
              _quillKeydownHandler2 = function _quillKeydownHandler(evt) {
                if (evt.key !== 'Tab') return;
                // ป้องกัน browser กดแท็บแล้วเปลี่ยนตำแหน่ง
                evt.preventDefault && evt.preventDefault();
                try {
                  var _ref3, _quillRef$value$getEd, _quillRef$value, _quillRef$value$getEd2, _quillRef$value2, _quillRef$value3;
                  var qu = instance || ((_ref3 = (_quillRef$value$getEd = (_quillRef$value = quillRef.value) === null || _quillRef$value === void 0 || (_quillRef$value$getEd2 = _quillRef$value.getEditor) === null || _quillRef$value$getEd2 === void 0 ? void 0 : _quillRef$value$getEd2.call(_quillRef$value)) !== null && _quillRef$value$getEd !== void 0 ? _quillRef$value$getEd : (_quillRef$value2 = quillRef.value) === null || _quillRef$value2 === void 0 ? void 0 : _quillRef$value2.editor) !== null && _ref3 !== void 0 ? _ref3 : (_quillRef$value3 = quillRef.value) === null || _quillRef$value3 === void 0 ? void 0 : _quillRef$value3.quill) || null;
                  if (qu && typeof qu.getSelection === 'function') {
                    var sel = qu.getSelection(true);
                    if (!sel) {
                      return;
                    }
                    var formats = qu.getFormat(sel.index, sel.lenght || 0) || {};
                    // หาก format ที่ใช้อยู่ใน list setting ของ Quill ให้ใช้
                    if (formats.list) {
                      var currentIndent = formats.indent || 0;
                      if (evt.shiftKey) {
                        var newIndent = Math.max(0, currentIndent - 1);
                      ...
                      if (evt.shiftKey) {
                        var _qu$getLine = qu.getLine(sel.index),
                          _qu$getLine2 = _slicedToArray(_qu$getLine, 2),
                          line = _qu$getLine2[0],
                          offsetInLine = _qu$getLine2[1];
                        var lineStart = sel.index - offsetInLine;
                        var lineText = qu.getText(lineStart, offsetInLine);
                        if (!lineText) {
                          return;
                        }
                        var match = /^\t| {1,4}/.exec(lineText);
                        if (match) {
                ...
                try {
                  root.addEventListener('keydown', _quillKeydownHandler2, true);
                } catch (e) {}
              };
            }
          case 4:
    ...
    try {
      var Font = quill__WEBPACK_IMPORTED_MODULE_0__["default"]["import"]('formats/font');
      Font.whitelist = ['Kanit', 'sans-serif'];
      quill__WEBPACK_IMPORTED_MODULE_0__["default"].register(Font, true);
    } catch (e) {
          ...
          bindings: {
            tab: {
              ...
              handler: function handler(range, context) {
                var evt = arguments[2]; // keydown event
                if (evt && evt.shiftKey) {
    ...
    var catLoading = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)(false);
    var categoriesById = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)({});
    var userById = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)({});

    /* computed */
    var categoryName = (0,vue__WEBPACK_IMPORTED_MODULE_1__.computed)(function () {
      var _categoriesById$value, _categories$value$fin;
      return (_categoriesById$value = categoriesById.value[form.value.category_id]) !== null && _categoriesById$value !== void 0 ? _categoriesById$value : ((_categories$value$fin = categories.value.find(function (c) {
        return c.id === form.value.category_id;
      })) === null || _categories$value$fin === void 0 ? void 0 : _categories$value$fin.name) || '';
    });
    var previewPublishAt = (0,vue__WEBPACK_IMPORTED_MODULE_1__.computed)(function () {
      if (!form.value.publish_date && !form.value.publish_time && !form.value.publish_at) return '-';
      if (form.value.publish_at) {
        try {
          var d = new Date(form.value.publish_at.replace(' ', 'T'));
      ...
      try {
        var dt = "".concat(form.value.publish_date || '', "T").concat(form.value.publish_time || '');
        var _d = new Date(dt);
        return isNaN(_d.getTime()) ? '-' : _d.toLocaleString();
      } catch (_unused2) {
        return '-';
      }
    });
    ...
    */
    ...
    function transformQuillClassesToInline(html) {
      try {
        var _quInstance$value;
        var parser = new DOMParser();
        var doc = parser.parseFromString(String(html || ''), 'text/html');
        if (!doc || !doc.body) return html;

        // try read Delta attributes per-line from Quill instance
        var qu = (_quInstance$value = quInstance.value) !== null && _quInstance$value !== void 0 ? _quInstance$value : null;
        var lineAttrs = [];
        if (qu && typeof qu.getContents === 'function') {
          try {
            var delta = qu.getContents();
            var lineIndex = 0;
        ...
        var blocks = Array.from(doc.body.children);
        blocks.forEach(function (el, idx) {
          var attrs = lineAttrs[idx] || {};
          if (attrs.align) {
            el.style.textAlign = attrs.align;
          }
          if (typeof attrs.indent !== 'undefined') {
            var indentLevel = Number(attrs.indent) || 0;
            el.style.marginLeft = "".concat(indentLevel * 2, "rem");
          }
        });

        // ถ้ายังมี class ql-align-* หรือ ql-indent-* ที่เหลืออยู่ ให้แปลงเป็น inline styles
        doc.querySelectorAll('.ql-align-center').forEach(function (el) {
          return el.style.textAlign = 'center';
        });
        doc.querySelectorAll('.ql-align-right').forEach(function (el) {
          return el.style.textAlign = 'right';
        });
        doc.querySelectorAll('.ql-align-justify').forEach(function (el) {
          return el.style.textAlign = 'justify';
        });
        doc.querySelectorAll('.ql-align-left').forEach(function (el) {
          return el.style.textAlign = 'left';
        });
        var _loop = function _loop(i) {
          doc.querySelectorAll(".ql-indent-".concat(i)).forEach(function (el) {
            el.style.marginLeft = "".concat(i * 2, "rem");
          });
        };
        for (var i = 1; i <= 6; i++) {
          _loop(i);
    ...
    var sanitizedHtml = (0,vue__WEBPACK_IMPORTED_MODULE_1__.computed)(function () {
      var raw = '';
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              ...
              _context2.p = 1;
              _context2.n = 2;
              return _services_BackendService_js__WEBPACK_IMPORTED_MODULE_2__["default"].get('/admin/policy-categories', {
                params: {
                  per: 0
                }
              });
    ...
    function printPreview() {
      var rawHtml = '';
      try {
        var _quInstance$value2;
        // อ่าน raw HTML จาก Quill editor
        var q = (_quInstance$value2 = quInstance.value) !== null && _quInstance$value2 !== void 0 ? _quInstance$value2 : null;
        if (q && q.root && q.root.innerHTML) {
      ...
      var transformQuillClassesToInline = function transformQuillClassesToInline(html) {
        try {
          var parser = new DOMParser();
      ...
      var printableHtml = transformQuillClassesToInline(rawHtml);

      // sanitize ก่อนนำไปแสดงในหน้าพิมพ์
      printableHtml = dompurify__WEBPACK_IMPORTED_MODULE_3__["default"].sanitize(printableHtml, {
        USE_PROFILES: {
          html: true
        },
        ADD_ATTR: ['class', 'style']
      });
      var title = form.value.title || 'ไม่มีหัวข้อ';
      var type = categoryName.value || '-';
      var status = previewPublishAt.value || '-';
      ...
      printWindow.document.write("\n    <html>\n      <head>\n        <meta charset=\"utf-8\"/>\n        <title>Preview - ".concat(title, "</title>\n       <style>\n            body{font-family:").concat(appFont, ";padding:24px;color:#222}\n            .content{line-height:1.6; white-space: pre-wrap; word-wrap: break-word;}\n            \n            .content .ql-align-center{ text-align:center !important; }\n            .content .ql-align-right{ text-align:right !important; }\n            .content .ql-align-justify{ text-align:justify !important; }\n          </style>\n      </head>\n      <body>\n        <h3>").concat(title, "</h3>\n        <div class=\"meta\">\u0E1B\u0E23\u0E30\u0E40\u0E20\u0E17: ").concat(type, " &nbsp;&nbsp; \u0E40\u0E1C\u0E22\u0E41\u0E1E\u0E23\u0E48: ").concat(status, "</div>\n        <div class=\"content\">").concat(printableHtml, "</div>\n      </body>\n    </html>\n  "));

      // copy font จาก head มาให้ด้วย
      try {
        var headNodes = Array.from(document.head.querySelectorAll('link[rel="stylesheet"], style'));
    ...
    var __returned__ = {
      ...
      get _quillKeydownHandler() {
        return _quillKeydownHandler2;
      },
      set _quillKeydownHandler(v) {
        _quillKeydownHandler2 = v;
      },
      get _quillChangeHandler() {
        return _quillChangeHandler;
      },
      set _quillChangeHandler(v) {
        _quillChangeHandler = v;
      },
      get _quillEditorChangeHandler() {
        return _quillEditorChangeHandler;
      },
      set _quillEditorChangeHandler(v) {
        _quillEditorChangeHandler = v;
      },
      get _quillMutObserver() {
        return _quillMutObserver;
      },
      set _quillMutObserver(v) {
        _quillMutObserver = v;
      },
      resolveQuill: resolveQuill,
      ...
      previewPublishAt: previewPublishAt,
      transformQuillClassesToInline: transformQuillClassesToInline,
      sanitizedHtml: sanitizedHtml,
      loadCategories: loadCategories,
      printPreview: printPreview,
      get Quill() {
        return quill__WEBPACK_IMPORTED_MODULE_0__["default"];
      },
      ...
      get http() {
        return _services_BackendService_js__WEBPACK_IMPORTED_MODULE_2__["default"];
      },
      get DOMPurify() {
...
var _hoisted_20 = {
  "class": "text-lg font-semibold mb-2 my-3 text-zinc-700"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" ฟอร์ม "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("form", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" ซ้าย "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [_cache[12] || (_cache[12] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createStaticVNode)("<div class=\"grid grid-cols-1\"><div class=\"flex\"><label class=\"font-medium mr-3\">ผู้รับนโยบาย: </label><div class=\"flex flex-col\"><div class=\"flex items-center gap-2\"><input type=\"radio\" id=\"option1\" name=\"recipient\" class=\"accent-red-700 w-4 h-4 text-red-600 focus:ring-red-500\"><label for=\"option1\" class=\"text-gray-700\">ทุกคน</label></div><div class=\"flex items-center gap-2 mt-2\"><input type=\"radio\" id=\"option2\" name=\"recipient\" class=\"accent-red-700 w-4 h-4 text-red-600 focus:ring-red-500\"><label for=\"option2\" class=\"text-gray-700\">กำหนดเป้าหมาย</label></div></div></div></div>", 1)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [_cache[8] || (_cache[8] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "font-medium mr-3"
  }, "เวลาประกาศ: ", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [_cache[7] || (_cache[7] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    ...
    "for": "option3",
    "class": "text-gray-700"
  }, "ประกาศตอนนี้")], -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [_cache[6] || (_cache[6] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    type: "radio",
    id: "option4",
    name: "announce",
    "class": "accent-red-700 w-4 h-4 text-red-600 focus:ring-red-500"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_10, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_11, [_cache[4] || (_cache[4] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
  ...
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.form.publish_date]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_12, [_cache[5] || (_cache[5] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "my-1 text-gray-500 text-xs",
    "for": ""
  ...
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.form.publish_time]])])])])])])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_13, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[9] || (_cache[9] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
  ...
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.form.title]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "block mb-1 font-medium"
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: c.id,
      value: c.id
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(c.name), 9 /* TEXT, PROPS */, _hoisted_14);
  }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $setup.form.category_id]]), $setup.catLoading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("small", _hoisted_15, "กำลังโหลด...")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_16, [_cache[14] || (_cache[14] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "block mb-1 font-medium"
  }, "ข้อมูลนโยบาย/มาตรการองค์กร *", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[13] || (_cache[13] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    "class": "block mb-1 font-medium"
  }, null, -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_17, null, 512 /* NEED_PATCH */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_18, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Live Preview "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_19, [_cache[16] || (_cache[16] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "text-xl text-gray-500 mb-2"
  }, "ตัวอย่างเอกสาร (Preview)", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    onClick: $setup.printPreview,
    "class": "px-3 py-1 text-xs bg-zinc-200 rounded flex"
    ...
    "class": "pl-1"
  }, "พิมพ์ตัวอย่าง", -1 /* CACHED */)]))), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", _hoisted_20, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.form.title || ''), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    "class": "prose whitespace-pre-wrap",
    innerHTML: $setup.sanitizedHtml
  }, null, 8 /* PROPS */, _hoisted_21), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_22, " ประเภทนโยบาย: " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.categoryName || '-') + " สถานะการประกาศ: " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.previewPublishAt || '-'), 1 /* TEXT */)])]), _cache[17] || (_cache[17] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/laravel-mix/node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/quill/dist/quill.snow.css":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/laravel-mix/node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/quill/dist/quill.snow.css ***!
  \**********************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_laravel_mix_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_quill_snow_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../laravel-mix/node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./quill.snow.css */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/laravel-mix/node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/quill/dist/quill.snow.css");
...
var update = _laravel_mix_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_laravel_mix_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_quill_snow_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_laravel_mix_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_quill_snow_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
